...
export function CaseCard({ locale, study }: CaseCardProps) {
  return (
    <article className="surface-panel group flex h-full flex-col justify-between rounded-[2.25rem] p-5 transition duration-300 motion-safe:hover:-translate-y-0.5 motion-safe:hover:shadow-[0_18px_40px_-20px_rgba(0,0,0,0.55)] hover:border-cyan-200/30 sm:p-[1.625rem] md:p-8">
      ...
      <div className="mt-10 flex items-center justify-between border-t border-white/8 pt-5 md:mt-11">
        ...
        >
          {locale === "en" ? "Read case study" : "Leer caso"}
          <span
            aria-hidden="true"
